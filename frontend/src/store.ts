...
const defaultPresets: Preset[] = [
  ...
  },
  {
    id: '9',
    name: 'ECLIPSE_PEAK',
    description: 'Total solar eclipse at maximum corona brilliance',
    category: 'eclipse',
    isCore: true,
    sortOrder: 9,
    visualState: {
  ...
  },
  {
    id: '10',
    name: 'DIAMOND_RING',
    description: 'Partial eclipse with brilliant diamond ring effect',
    category: 'eclipse',
    isCore: true,
    sortOrder: 10,
    visualState: {
  ...
  },
  {
    id: '11',
    name: 'CORONA_BLAZE',
    description: 'Intense corona streamers with fire palette',
    category: 'eclipse',
    isCore: true,
    sortOrder: 11,
    visualState: {
